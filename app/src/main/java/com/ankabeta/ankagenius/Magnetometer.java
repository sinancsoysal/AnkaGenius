...
public class Magnetometer extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onResume() {
        ...
        if (!sharedpreferences.getBoolean(prevStarted, false)) {
            ...
            textView.setText ("\n" +
                    "Telefonu şüpheli alanların olduğu bölgelere yaklaştırın");
            alert.setView(mView);
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (sensor.getType() == Sensor.TYPE_MAGNETIC_FIELD){
            ...
            if(Double.compare (x,Pd)>0 && Double.compare (x,Fd)<0) {
                ...
                mediaPlayer.start();
                show_conditions.setText( "Potansiyel elektronik cihaz bulundu" );
                ...
                mediaPlayer.start();
                show_conditions.setText("Elektronik cihaz bulundu");

            }else {
                mediaPlayer = null;
                show_conditions.setText ("Potansiyel elektronik cihaz bulunamadı");
            }
