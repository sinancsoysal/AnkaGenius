...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (permissionCheck != PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission (MainActivity.this,
            ...
            heading.setText("AnkaGenius'un izinlere ihtiyacı var");
            TextView sms=mView.findViewById (R.id.sms);
            sms.setText("SMS Gönderme:");
            TextView textView=mView.findViewById (R.id.textFormodal);
            textView.setText ("Acil durum mesajlaşma sistemi SMS Gönderme iznine ihtiyaç duyar.");
            TextView location=mView.findViewById (R.id.location);
            location.setText("Konum:");
            TextView locationText=mView.findViewById (R.id.textLocation);
            locationText.setText("Konum sistemi konum bilgisine ihtiyaç duyar.");
            TextView call=mView.findViewById (R.id.call);
            call.setText("Arama:");
            TextView callText=mView.findViewById (R.id.textCall);
            callText.setText("Acil durum arama sistemi arama iznine ihtiyaç duyar.");
            TextView declaration=mView.findViewById (R.id.declaration);
            declaration.setText("Bilgilendirme");
            TextView declaratioText=mView.findViewById (R.id.textDeclaration);
            declaratioText.setText("Uygulamaya ait bütün bilgiler cihazın lokal hafızasında KVKK gerekliliklerine uygun olarak saklanmaktadır.");
            ...
            checkbox.setText("");
            checkBoxtext.setText(Html.fromHtml("Uygulamayı kullanabilmek için " +
                    "<a href='https://www.ankabeta.com.tr/gizlilikpolitikasi/'>GİZLİLİK SÖZLEŞMESİ</a>Nİ"+" kabul ediyorum."));
            ...
            btn_okay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(checkbox.isChecked ()) {
                        ...
                        Toast.makeText (MainActivity.this,"Lütfen gizlilik sözleşmesini kabul edin",Toast.LENGTH_LONG).show ();
        ...
        shareBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               try {
                    ...
                    shareIntent.putExtra(Intent.EXTRA_SUBJECT, "AnkaGenius");
                    String shareMessage= "AnkaGenius uygulamasını indir:";

                    shareMessage = shareMessage + "https://play.google.com/store/apps/details?id=" + com.ankabeta.ankagenius.BuildConfig.APPLICATION_ID ;
